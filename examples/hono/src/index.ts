        ...
        <div id="not-logged-in" style="display:none;">
            <div style="display: flex; flex-direction: column; gap: 12px; align-items: center;">
                ...
                <div style="display: flex; align-items: center; margin: 8px 0;">
                    <div style="border-top: 1px solid #e5e7eb; flex: 1;"></div>
                    <span style="padding: 0 12px; color: #6b7280; font-size: 0.875rem;">or</span>
                    <div style="border-top: 1px solid #e5e7eb; flex: 1;"></div>
                </div>
                <button onclick="loginAnonymously()" class="secondary-btn">Login Anonymously</button>
            </div>
        </div>
